...
static DataTypeTransition rtBTransitions[] = {
  { (char_T *)(&MPC_B.Sum), 0, 0, 6 },

  { (char_T *)(&MPC_B.iter), 6, 0, 2 }
  ,

  { (char_T *)(&MPC_DW.Delay_DSTATE[0]), 0, 0, 76 },
...
static DataTypeTransition rtPTransitions[] = {
  { (char_T *)(&MPC_P.A_iq[0]), 0, 0, 1299 },

  { (char_T *)(&MPC_P.HILReadAnalog1_channels[0]), 7, 0, 6 },

  { (char_T *)(&MPC_P.HILInitialize_OOTerminate), 0, 0, 52 },

  { (char_T *)(&MPC_P.HILInitialize_CKChannels[0]), 6, 0, 9 },

  { (char_T *)(&MPC_P.HILInitialize_AIChannels[0]), 7, 0, 34 },
