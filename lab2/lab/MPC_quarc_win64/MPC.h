...
typedef struct {
  real_T Sum;                          /* '<S1>/Sum' */
  real_T Sum1;                         /* '<S1>/Sum1' */
  real_T u1[2];                        /* '<Root>/Discrete Transfer Fcn' */
  real_T Add[2];                       /* '<Root>/Add' */
...
typedef struct {
  ...
  real_T DiscreteTransferFcn_tmp[2];   /* '<Root>/Discrete Transfer Fcn' */
...
struct P_MPC_T_ {
  real_T A_iq[445];                    /* Variable: A_iq
                                        * Referenced by: '<Root>/Constant2'
                                        */
  real_T Fx[80];                       /* Variable: Fx
                                        * Referenced by: '<Root>/Gain3'
                                        */
  real_T Fy[40];                       /* Variable: Fy
                                        * Referenced by: '<Root>/Gain2'
                                        */
  real_T Gx[80];                       /* Variable: Gx
                                        * Referenced by: '<Root>/Gain'
                                        */
  real_T Gy[40];                       /* Variable: Gy
                                        * Referenced by: '<Root>/Gain1'
                                        */
  real_T Hy[80];                       /* Variable: Hy
                                        * Referenced by: '<Root>/MATLAB Function'
                                        */
  real_T L[8];                         /* Variable: L
                                        * Referenced by: '<Root>/MATLAB Function'
                                        */
  real_T Qy[400];                      /* Variable: Qy
                                        * Referenced by: '<Root>/MATLAB Function'
                                        */
  real_T W_delta[25];                  /* Variable: W_delta
  ...
  real_T roh;                          /* Variable: roh
                                        * Referenced by: '<Root>/MATLAB Function'
                                        */
  real_T u_max[4];                     /* Variable: u_max
                                        * Referenced by: '<Root>/MATLAB Function'
                                        */
  real_T u_min[4];                     /* Variable: u_min
                                        * Referenced by: '<Root>/MATLAB Function'
                                        */
  real_T ue[2];                        /* Variable: ue
                                        * Referenced by: '<Root>/Constant5'
                                        */
  real_T x_max[40];                    /* Variable: x_max
                                        * Referenced by: '<Root>/MATLAB Function'
                                        */
  real_T x_min[40];                    /* Variable: x_min
                                        * Referenced by: '<Root>/MATLAB Function'
                                        */
  real_T xe[2];                        /* Variable: xe
                                        * Referenced by: '<Root>/Constant4'
                                        */
  real_T xe2;                          /* Variable: xe2
                                        * Referenced by: '<Root>/Constant3'
                                        */
  ...
  real_T HILInitialize_POWatchdog;     /* Expression: watchdog_pwm_outputs
                                        * Referenced by: '<Root>/HIL Initialize'
                                        */
  real_T Constant6_Value[20];          /* Expression: 15*ones(Np,1)
  ...
  real_T Delay_InitialCondition[2];    /* Expression: [0;0]
                                        ...
                                        */
  real_T DiscreteTransferFcn_NumCoef[2];/* Expression: [1 0]
                                         * Referenced by: '<Root>/Discrete Transfer Fcn'
                                         */
  real_T DiscreteTransferFcn_DenCoef[2];/* Expression: [1 -1]
                                         * Referenced by: '<Root>/Discrete Transfer Fcn'
                                         */
  real_T DiscreteTransferFcn_InitialStat[2];/* Expression: [0;0]
                                             * Referenced by: '<Root>/Discrete Transfer Fcn'
                                             */
