...
typedef RT_MODEL_Experiment_2_moving__T RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * Experiment_2_moving_cart(void);
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(Experiment_2_moving_cart_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  rtExtModeQuarcParseArgs(argc, (const char **) argv,
    "shmem://Experiment_2_moving_cart:1");
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: Experiment_2_moving_cart -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
