...
#ifndef RTW_HEADER_Experiment_2_moving_cart_h_
#define RTW_HEADER_Experiment_2_moving_cart_h_
#include <float.h>
#include <math.h>
#include <string.h>
#ifndef Experiment_2_moving_cart_COMMON_INCLUDES_
# define Experiment_2_moving_cart_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* Experiment_2_moving_cart_COMMON_INCLUDES_ */

#include "Experiment_2_moving_cart_types.h"
...
#define Experiment_2_moving_cart_rtModel RT_MODEL_Experiment_2_moving__T

/* Block signals (default storage) */
typedef struct {
  real_T Gain1;                        /* '<S3>/Gain1' */
  real_T Sum;                          /* '<S4>/Sum' */
  real_T u;                            /* '<Root>/Transport Delay' */
  real_T TmpSignalConversionAtToWorkspac[4];/* '<Root>/Pendulum' */
  real_T Gain;                         /* '<S1>/Gain' */
  real_T iA;                           /* '<Root>/Manual Switch' */
  real_T Saturation;                   /* '<S2>/Saturation' */
  real_T Phi;                          /* '<S4>/Embedded MATLAB Function' */
  real_T x0;                           /* '<S6>/Differentiator' */
  real_T z;                            /* '<S6>/Differentiator' */
  real_T x0_n;                         /* '<S5>/Differentiator' */
  real_T z_h[2];                       /* '<S5>/Differentiator' */
} B_Experiment_2_moving_cart_T;

/* Block states (default storage) for system '<Root>' */
typedef struct {
  emxArray_real_T_3x3_Experimen_T Phi; /* '<S5>/Differentiator' */
  emxArray_real_T_2x2_Experimen_T Phi_b;/* '<S6>/Differentiator' */
  emxArray_real_T_3_Experiment__T bD;  /* '<S5>/Differentiator' */
  emxArray_real_T_3_Experiment__T So_inv_lastCol;/* '<S5>/Differentiator' */
  emxArray_real_T_3_Experiment__T zp;  /* '<S5>/Differentiator' */
  emxArray_real_T_2_Experiment__T bD_e;/* '<S6>/Differentiator' */
  emxArray_real_T_2_Experiment__T So_inv_lastCol_e;/* '<S6>/Differentiator' */
  emxArray_real_T_2_Experiment__T zp_p;/* '<S6>/Differentiator' */
  ...
  boolean_T zp_not_empty;              /* '<S6>/Differentiator' */
  boolean_T zp_not_empty_n;            /* '<S5>/Differentiator' */
} DW_Experiment_2_moving_cart_T;

/* Backward compatible GRT Identifiers */
#define rtB                            Experiment_2_moving_cart_B
#define BlockIO                        B_Experiment_2_moving_cart_T
#define rtP                            Experiment_2_moving_cart_P
#define Parameters                     P_Experiment_2_moving_cart_T
#define rtDWork                        Experiment_2_moving_cart_DW
#define D_Work                         DW_Experiment_2_moving_cart_T

/* Parameters (default storage) */
struct P_Experiment_2_moving_cart_T_ {
  real_T gain_cart;                    /* Variable: gain_cart
                                        * Referenced by: '<S3>/Gain1'
                                        */
  real_T gain_pendulum;                /* Variable: gain_pendulum
  ...
  real_T ChirpSignal_f2;               /* Mask Parameter: ChirpSignal_f2
                                        ...
                                        */
  real_T Differentiator_mu;            /* Mask Parameter: Differentiator_mu
                                        * Referenced by: '<S5>/Differentiator'
                                        */
  real_T Differentiator1_mu;           /* Mask Parameter: Differentiator1_mu
                                        * Referenced by: '<S6>/Differentiator'
                                        */
  ...
  real_T Step2_Y0;                     /* Expression: 0
                                        * Referenced by: '<Root>/Step2'
                                        */
  real_T Step2_YFinal;                 /* Expression: 6
                                        * Referenced by: '<Root>/Step2'
                                        */
...
struct tag_RTM_Experiment_2_moving_c_T {
  const char_T *path;
...
extern P_Experiment_2_moving_cart_T Experiment_2_moving_cart_P;

/* Block signals (default storage) */
extern B_Experiment_2_moving_cart_T Experiment_2_moving_cart_B;

/* Block states (default storage) */
extern DW_Experiment_2_moving_cart_T Experiment_2_moving_cart_DW;

/* Model entry point functions */
extern void Experiment_2_moving_cart_initialize(void);
extern void Experiment_2_moving_cart_output(void);
extern void Experiment_2_moving_cart_update(void);
extern void Experiment_2_moving_cart_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern Experiment_2_moving_cart_rtModel *Experiment_2_moving_cart(void);
...
extern RT_MODEL_Experiment_2_moving__T *const Experiment_2_moving_cart_M;
 ...
 *
 * '<Root>' : 'Experiment_2_moving_cart'
 * '<S1>'   : 'Experiment_2_moving_cart/Chirp Signal'
 * '<S2>'   : 'Experiment_2_moving_cart/Pendulum'
 * '<S3>'   : 'Experiment_2_moving_cart/Pendulum/Quanser IO'
 * '<S4>'   : 'Experiment_2_moving_cart/Pendulum/Subsystem1'
 * '<S5>'   : 'Experiment_2_moving_cart/Pendulum/Subsystem1/Differentiator'
 * '<S6>'   : 'Experiment_2_moving_cart/Pendulum/Subsystem1/Differentiator1'
 * '<S7>'   : 'Experiment_2_moving_cart/Pendulum/Subsystem1/Embedded MATLAB Function'
 * '<S8>'   : 'Experiment_2_moving_cart/Pendulum/Subsystem1/Differentiator/Differentiator'
 * '<S9>'   : 'Experiment_2_moving_cart/Pendulum/Subsystem1/Differentiator1/Differentiator'
 */
#endif                                 /* RTW_HEADER_Experiment_2_moving_cart_h_ */
